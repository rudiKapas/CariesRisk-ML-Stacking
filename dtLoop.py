...
def evaluate_model(k_folds, criterion, max_depth, min_samples_split, min_samples_leaf):
...
results = Parallel(n_jobs=-1)(
    delayed(evaluate_model)(k_folds, criterion, max_depth, min_samples_split, min_samples_leaf)
    for k_folds, criterion, max_depth, min_samples_split, min_samples_leaf
    in product(k_values, criterion_list, max_depth_list, min_samples_split_list, min_samples_leaf_list))
...
print("Training completed. Results saved to decision_tree_results.csv")
...
plt.title('ROC-AUC Curve for Best Decision Tree Model')
plt.legend()
plt.grid(True)
plt.savefig('roc_auc_curve_decision_tree.png')
plt.show()
print("ROC-AUC Curve saved as roc_auc_curve_decision_tree.png")
